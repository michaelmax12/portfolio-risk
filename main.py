...
with col2:
    if not ticker_list:
            ...
            if "^JKSE" in ticker_list:
                ...
                if st.button("Run Black-Litterman Analysis"):
                    with st.spinner("Calculating BL Posterior and running backtests..."):
                        ...
                        st.plotly_chart(fig_pnl, width="stretch", key="bl_pnl_chart")
        ...
        with tab5:
            ...
            st.plotly_chart(fig, width="stretch",key="hrp_dendrogram_chart")
            ...
            if selection == "In-Sample":
                ...
                st.plotly_chart(fig_port_HRP, width="stretch", key="hrp_backtest_chart")
            else:
                st.markdown("### Use In-Sample for backtest")
        ...
        with tab6:
            ...
            if st.button("Run Portofolio Backtest (rebalance)"):
                ...
                st.plotly_chart(fig_rebalance, width="stretch", key="Porto_rebalance_backtest")
        ...
        with tab8:
            ...
            if selection == "In-Sample":
                ...
                st.plotly_chart(fig_port_HRP, width="stretch", key="PPP_backtest_chart")
            else:
                st.markdown("### Use In-Sample for backtest")
